...
- 大屏 HTML 委托 `bi-dashboard-generator`；按选型写业务代码交回本 Skill
...
| 选型 §2 / 数据模型 / 设计契约 / 开发计划 | 各一份、各审一次；无已审核计划不得写业务代码 |
| 业务代码 | 按 §2 实际栈实现确认卡上的 Mx–My；大屏工程化交回本 Skill |
...
| 时间 | 说明 |
|---|---|
| 2026-09-03 | 用户只交材料；转规格是 Skill 的事，不是用户义务 |
